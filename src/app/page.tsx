        ...
        <div className="owl-carousel header-carousel position-relative">
          {
            institutionData?.portada.map((data, _i) => (
              <div key={`portada-${_i}`} className="owl-carousel-item position-relative">
        ...
        <div className="container">
          <div className="row g-5">
            ...
            <div className="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
              ...
              <div dangerouslySetInnerHTML={{ __html: DOMPurify.sanitize(institutionData?.institucion_objetivos) }} />
        ...
        <div className="container">
          <div className="row g-5">
            ...
            <div className="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
              ...
              <h1 className="mb-4">
                {noticia?.[0]?.video_titulo}
              </h1>
              <div dangerouslySetInnerHTML={{ __html: DOMPurify.sanitize(noticia?.[0]?.video_breve_descripcion) }} />
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="container">
          <div className="row g-5">
            <div className="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
              ...
              <div dangerouslySetInnerHTML={{ __html: DOMPurify.sanitize(actividades?.[0]?.video_breve_descripcion) }} />
            </div>
            <div className="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
              <div className="ratio ratio-16x9">
                <iframe
                ...
                >
                  <div className="course-item bg-light">
                    <div className="position-relative overflow-hidden">
                      <img className="img-fluid" src={`${process.env.NEXT_PUBLIC_API_URL}/Publicaciones/${data.publicaciones_imagen}`} alt="" />
