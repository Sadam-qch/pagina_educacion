                  ...
                  <div className="flex flex-wrap justify-between p-4">
                    <div className="w-full p-4 text-justify md:w-1/2">
                      <h2 className="flex items-center space-x-2">
                        <FaPhone /> <span>{institutionData?.institucion_celular1}</span>
                      </h2>
                      <h2 className="flex items-center space-x-2">
                        <FaPhone /> <span>{institutionData?.institucion_celular1}</span>
                      </h2>
                    ...
                    <div className="w-full p-4 text-justify md:w-1/2">
                      <h2 className="flex items-center space-x-2">
                        <FaEnvelope /> <span>{institutionData?.institucion_correo1}</span>
                      </h2>
                      <h2 className="flex items-center space-x-2">
                        <FaGoogle /> <span>{institutionData?.institucion_correo2}</span>
                      </h2>
                      <h2 className="flex items-center space-x-2">
                        <FaMapLocation /> <span>{institutionData?.institucion_direccion}</span>
                      </h2>
                    </div>
                  </div>
